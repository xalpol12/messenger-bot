...
public interface IWebhookController {
    ...
    ResponseEntity<?> receiveWebhook(@Parameter(name = "signature", description = "checksum for security verification")
    ...
    ResponseEntity<?> verifyWebhookSubscription(@Parameter(name = "mode", description = "Should always have value \"subscription\"")
